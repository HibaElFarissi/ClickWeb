...
<form class="row g-3 needs-validation" action="{{ $route }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        ...
        <div class="position-relative">
            <textarea cols="30" name="text" rows="5" class="form-control py-3 @error('text') is-invalid @enderror"
                id="text" placeholder="text" required>{{ old('text',  $Article->text) }}</textarea>
    ...
    <div class="col-lg-12">
        <div class="form-group mb-4">
            ...
            <div class="form-group position-relative">
                <select name="article_category_id" id="article_category_id" class="form-select form-control h-58" aria-label="Default select example">
