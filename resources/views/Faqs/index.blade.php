    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-semibold fs-18 mb-0">All Faq</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-10">
                                                <h4 class="fw-semibold fs-14 mb-0">{{$item->question}}</h4>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-10">
                                                <h4 class="fw-semibold fs-14 mb-0">{{$item->Answer}}</h4>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="dropdown action-opt">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                ...
                                                <li>
                                                    ...
                                                    <form action="{{ route('Faqs.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                        @csrf
                                                        @method('DELETE')
