...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('Categorie_Designs.update', $Categorie_Design->id) }}" method="POST"
        ...
        <div class="col-md-6">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('name') is-invalid @enderror" name="name"
                    id="validationCustom10" value="{{ old('name', $Categorie_Design->name) }}" required>
