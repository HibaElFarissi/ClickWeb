				...
				<div class="row">
					<div class="col-lg-6">
						<div class="common-heading text-l">
							...
							<p class="mt10">Lorem Ipsum is text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
