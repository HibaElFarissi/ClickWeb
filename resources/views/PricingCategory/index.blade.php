...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Categorie Pricings</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Categorie Pricings</span>
            </li>
        </ul>
    </div>
                    ...
                    <div class="default-table-area recent-files-list">
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    @forelse ( $Categorie_Pricings as $Categorie )
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('PricingCategory.edit', $Categorie->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('PricingCategory.destroy', $Categorie) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create Categorie Pricings</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body p-4">
            <form  action="{{ route('PricingCategory.store') }}" method="POST">
                @csrf
               
               
                    <div class="form-group mb-4">
                        <label class="label">Categorie Pricing Name</label>
