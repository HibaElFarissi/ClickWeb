...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('ArticleCategorys.update', $Categorie_Article->id) }}" method="POST"
        ...
        <div class="col-md-6">
            ...
            <div class="position-relative">
                <input type="text" class="form-control h-58 @error('name') is-invalid @enderror" name="name"
                    id="validationCustom10" value="{{ old('name', $Categorie_Article->name) }}" required>
