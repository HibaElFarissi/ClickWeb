...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Demande</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Demande</span>
            </li>
        </ul>
    </div>
    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            <div class="d-sm-flex justify-content-between text-center align-items-center border-bottom pb-20 mb-20">
                <h4 class="fw-semibold fs-18 mb-sm-0">Demande List</h4>
                        ...
                        <thead>
                            <tr class="text-center">
                                ...
                                <th scope="col">site</th>
                                     <th scope="col">contactez_nous</th>
                            ...
                            <tr class="text-center">
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h4 class="fw-semibold fs-14 mb-0">{{$item->Full_name}}</h4>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-10">
                                            <h4 class="fw-semibold fs-14 mb-0">{{$item->Telephone}}</h4>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-10">
                                            <h4 class="fw-semibold fs-14 mb-0">{{$item->Site}}</h4>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-10">
                                            <h4 class="fw-semibold fs-14 mb-0">{{$item->contactez_nous}}</h4>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-10">
                                            <h4 class="fw-semibold fs-14 mb-0">{{$item->investissement}}</h4>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-start">
                                    ...
                                    <div class="dropdown action-opt">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('Demande.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                    @csrf
                                                    @method('DELETE')
