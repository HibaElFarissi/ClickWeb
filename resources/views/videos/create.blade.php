...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Create Video</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Create Video</span>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h3 class="fs-18  border-bottom pb-20 mb-20">Create Video</h3>
                    <form action="{{ route('Videos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                             ...
                             <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    <label class="label">Attached Files photo</label>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-4">
                                    <label class="label">code_video</label>
                                    <div class="form-group position-relative">
                                        <input type="text" name="code_video" class="form-control text-dark h-58 ps-5"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group position-relative mb-3">
                                    <select name="categorie_video_id" id="categorie_video_id"
