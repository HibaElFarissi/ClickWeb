...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18"> Features</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2"> Features</span>
            </li>
        </ul>
    </div>
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-sm-flex justify-content-between text-center align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0"> Features</h4>
                                        ...
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-10">
                                                    <h4 class="fw-semibold fs-14 mb-0">{{$Feature->title}}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-10">
                                                    <h4 class="fw-semibold fs-14 mb-0">{{$Feature->description}}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('Features.edit', $Feature->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('Features.destroy', $Feature) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create Features</h5>
            ...
            <form  action="{{ route('Features.store') }}" method="POST"      enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group mb-4">
                        <label class="label"> Features title</label>
                        <input type="text" name="title" class="form-control text-dark @error('title') is-invalid @enderror" placeholder=" title" value="{{ old('title') }}" required>
                     @error('title')
