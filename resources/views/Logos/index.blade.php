...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18"> Logos</h3>
        <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
            ...
            <li>
                <span class="fw-semibold fs-14 heading-font text-dark dot ms-2"> Logos</span>
            </li>
        </ul>
    </div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <a href="#" class="d-flex align-items-center mw-380">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('storage/' . $Logo->photo) }}"
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('Logos.edit', $Logo->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('Logos.destroy', $Logo) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create Logos</h5>
